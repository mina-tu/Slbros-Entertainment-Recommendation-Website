  ...
  class SiteFooter extends HTMLElement {
    connectedCallback() {
      ...
      this.innerHTML =
        ...
        '    <div class="ft-col"><h3>遊戲分類</h3><ul><li><a href="slot-recommend.html">老虎機</a></li><li><span style="color:var(--n300);font-size:14px">真人娛樂</span></li><li><span style="color:var(--n300);font-size:14px">體育投注</span></li><li><a href="table-games-recommend.html">桌上遊戲</a></li><li><span style="color:var(--n300);font-size:14px">原創遊戲</span></li></ul></div>' +
